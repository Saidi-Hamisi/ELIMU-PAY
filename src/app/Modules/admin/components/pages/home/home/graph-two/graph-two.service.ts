...
export class GraphTwoService {
  ...
  private incomeUrl = 'http://192.168.89.139:8000/api/v1/payfee/calculate_total_fee/'; // Replace with your API endpoint for income
  private expenseUrl = 'http://192.168.89.139:8000/api/v1/suppliers/suppliers/calculate_total_amount/'; // Replace with your API endpoint for expense
